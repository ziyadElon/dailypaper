        ...
        function (e, E) {
            ...
            if (!Ln(u, Ft)) {
                ...
                var x,
                    ...
                    l = "ontouchstart" in zt || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints,
                ...
                Ct(),
                    ...
                    d &&
                        ((h.version = "3.0.8"),
                        (h.setAutoScrolling = Z),
                        (h.setRecordHistory = ee),
                        (h.setScrollingSpeed = te),
                        (h.setFitToSection = ne),
                        (h.setLockAnchors = function (e) {
                            E.lockAnchors = e;
                        }),
                        (h.setMouseWheelScrolling = oe),
                        (h.setAllowScrolling = re),
                        (h.setKeyboardScrolling = le),
                        (h.moveSectionUp = ae),
                        (h.moveSectionDown = se),
                        (h.silentMoveTo = ce),
                        (h.moveTo = ue),
                        (h.moveSlideRight = fe),
                        (h.moveSlideLeft = de),
                        ...
                        (h.destroy = function (e) {
                            Z(!1, "internal"),
                                ...
                                le(!1),
                                Nn(d, Yt),
                                [b, w, m, O, M, C, S, P].forEach(function (e) {
                                    clearTimeout(e);
                                }),
                        ...
                        (h.shared = { afterRenderActions: Ee, isNormalScrollElement: !1 }),
                        (zt.fullpage_api = h),
                        E.$ &&
                        ...
                        (function () {
                            ...
                            E.fixedElements &&
                                ...
                                E.scrollOverflow && (g = E.scrollOverflowHandler.init(E));
                        })(),
                        re(!0),
                        ie(!0),
            ...
            function Z(e, t) {
                ...
                var n = yn(Qt)[0];
                if (E.autoScrolling && !E.scrollBar) Tn(r, { overflow: "hidden", height: "100%" }), ee(D.recordHistory, "internal"), Tn(d, { "-ms-touch-action": "none", "touch-action": "none" }), null != n && Tt(n.offsetTop);
                else if ((Tn(r, { overflow: "visible", height: "initial" }), ee(!!E.autoScrolling && D.recordHistory, "internal"), Tn(d, { "-ms-touch-action": "", "touch-action": "" }), null != n)) {
            ...
            function ve(e) {
                if (!Ln(d, Yt)) {
                    ...
                    E.scrollOverflow && g.createScrollBarForAll();
                    var l = In(yn(Qt)[0], qt);
            ...
            function he(e) {
                var t = pe();
                e
                    ? t || (Z(!1, "internal"), ne(!1, "internal"), Bn(yn(nn)), Nn(L, Vt), _n(E.afterResponsive) && E.afterResponsive.call(d, e), E.scrollOverflow && g.createScrollBarForAll())
                    ...
                    ("mouseenter" !== t || W) &&
                        (E.normalScrollElements.split(",").forEach(function (e) {
                            if (!o) {
                                var t = qn(i, e),
                                    n = Wn(i, e);
                                (t || n) && (h.shared.isNormalScrollElement || (ie(!1), r && E.scrollOverflowHandler.setIscroll(i, !1)), (h.shared.isNormalScrollElement = !0), (o = !0));
                            }
                        }),
                        !o && h.shared.isNormalScrollElement && (ie(!0), r && E.scrollOverflowHandler.setIscroll(i, !0), (h.shared.isNormalScrollElement = !1)));
            }
            function we() {
                var e = xn(),
                    t = An();
            ...
            function Re(e, t, n) {
                ...
                if (null != e) {
                  ...
                  var ulChildren = document.getElementById('home-desktop-dots').children;      
                  ...
                  var body_t = body.classList.contains("fp-viewing-0");
                  ...
                  if(body_t){                    
                    ...
                    body.classList.add('home-body');
                      ...
                      for(var i = 0; i < childrenLength; i++){
                        var li_id = ulChildren[i].getAttribute("data-id");
                        if(jj.actveLink == li_id){
            ...
            function yt(e) {
                ...
                else if (o || l) zt.history.replaceState(void 0, void 0, "#" + e);
                else {
            ...
            function xt(e) {
                ...
                return (
                    ...
                    l && Oe(e) && E.scrollBar && void 0 !== e.touches && ((t.y = e.touches[0].pageY), (t.x = e.touches[0].pageX)),
                    t
                );
            }
            function At(e, t) {
            ...
            function Tt(e) {
                ...
                else if (E.autoScrolling && !E.scrollBar) Tn(d, { top: -t + "px" }), (h.test.top = -t + "px");
                else {
                    var n = Pe(t);
